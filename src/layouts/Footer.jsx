...
const Footer = () => {
  ...
  <div className="rts-footer-area footer-two " id="rts-footer">
        ...
        <div className="col-lg-12">
          <div className="footer-wrapper-style-between">
            ...
            <div className="single-wized">
              <h6 style={{color:"black"}} className="title">Quick Links</h6>
              <div className="body">
                <ul className="nav-bottom">
                  <li><a style={{color:"black"}} href='/'>Home</a></li>
                  <li><Link style={{color:"black"}} to='about'>About</Link></li>
                  <li><Link style={{color:"black"}} to='service'>Service </Link></li>
                  <li><Link style={{color:"black"}} to='contact'>Contact Us</Link></li>
                </ul>
              </div>
            </div>
            <div className="single-wized">
              <h6 style={{color:"black"}} className="title">Contact Us</h6>
              <div className="body">
                <p style={{color:"black"}} className="phone d-flex align-items-center">
                  ...
                  <a style={{color:"black"}} href="tel:+919544727727">+919544727727</a>
                  </p>
                <p className="email d-flex align-items-center">
                  ...
                  <a style={{color:"black"}} href="mailto:careanytime@gmail.com">careanytime@gmail.com</a>
                  </p>
              </div>
            </div>
          </div>
